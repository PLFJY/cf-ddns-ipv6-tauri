...
export const SERVICE_PRESETS: PresetModel[] = [
  ...
  { name: "Minecraft Server", defaultPort: 25565, icon: "https://www.minecraft.net/content/dam/minecraftnet/games/minecraft/logos/Java-24px.png", defaultDescription: "Minecraft server" },
  ...
  { name: "SSH", defaultPort: 22, icon: "fluent:wrench-settings-24-regular", defaultDescription: "Secure shell access" },
